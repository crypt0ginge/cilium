...
Create a :download:`kind-config.yaml <./kind-config.yaml>` file based on the following template. The template
will create 3 node + 1 apiserver cluster with the latest version of kubernetes from when the kind release was created.
